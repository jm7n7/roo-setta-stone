    ...
    html.Div([
        ...
        html.Div([
            ...
            dcc.Link(html.Div([
                ...
                html.Button("Explore Pairings", style={'marginTop': '20px', 'padding': '10px 25px', 'backgroundColor': THEME['secondary'], 'color': 'white', 'border': 'none', 'borderRadius': '5px', 'cursor': 'pointer'})
            ], className='game-card', style={'backgroundColor': 'white', 'padding': '30px', 'borderRadius': '12px', 'boxShadow': '0 4px 12px rgba(0,0,0,0.1)', 'textAlign': 'center', 'width': '300px', 'transition': 'transform 0.2s'}), href='/unique-twins', style={'textDecoration': 'none'}),

            # Card 2: Individual Word Twins
            dcc.Link(html.Div([
                html.Div("🔡", style={'fontSize': '60px', 'marginBottom': '20px'}),
                ...
                html.Button("Explore Pairings", style={'marginTop': '20px', 'padding': '10px 25px', 'backgroundColor': THEME['secondary'], 'color': 'white', 'border': 'none', 'borderRadius': '5px', 'cursor': 'pointer'})
            ], className='game-card', style={'backgroundColor': 'white', 'padding': '30px', 'borderRadius': '12px', 'boxShadow': '0 4px 12px rgba(0,0,0,0.1)', 'textAlign': 'center', 'width': '300px', 'transition': 'transform 0.2s'}), href='/word-twins', style={'textDecoration': 'none'}),
